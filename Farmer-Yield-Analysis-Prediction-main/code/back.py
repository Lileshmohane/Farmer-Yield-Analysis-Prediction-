...
ann_model = load_model(r"C:\Users\liles\Downloads\Farmer-Yield-Analysis-Prediction-main\Farmer-Yield-Analysis-Prediction-main\model files\ann_model.h5")
...
scaler = joblib.load(r'C:\Users\liles\Downloads\Farmer-Yield-Analysis-Prediction-main\Farmer-Yield-Analysis-Prediction-main\model files\scaler.save') 
y_train_k = joblib.load(r'C:\Users\liles\Downloads\Farmer-Yield-Analysis-Prediction-main\Farmer-Yield-Analysis-Prediction-main\model files\y_train_k.joblib')
x_train_k = joblib.load(r'C:\Users\liles\Downloads\Farmer-Yield-Analysis-Prediction-main\Farmer-Yield-Analysis-Prediction-main\model files\x_train_k.joblib')
...
test_data = pd.read_csv(r'C:\Users\liles\Downloads\Farmer-Yield-Analysis-Prediction-main\Farmer-Yield-Analysis-Prediction-main\processed_test_city_weather_soil.csv')
...
crop_df = pd.read_csv(r"C:\Users\liles\Downloads\Farmer-Yield-Analysis-Prediction-main\Farmer-Yield-Analysis-Prediction-main\crop_recommendation.csv")
...
df_prices = pd.read_excel(r"C:\Users\liles\Downloads\Farmer-Yield-Analysis-Prediction-main\Farmer-Yield-Analysis-Prediction-main\price_data.xlsx")
