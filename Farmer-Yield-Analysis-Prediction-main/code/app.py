...
if nav == "Predict":
    ...
    if st.button("Predict & Analyze"):
        ...
        # Add an image
        img_file = r"C:\Users\liles\Downloads\Farmer-Yield-Analysis-Prediction-main\Farmer-Yield-Analysis-Prediction-main\Crop Images\{}.jpg".format(final_predicted_crops)
